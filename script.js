// Main JavaScript for Ozone Service Solutions

import { ScrollEffects } from './assets/js/scroll-effects.js';
import { CounterAnimation } from './assets/js/counter-animation.js';
import { FormValidator } from './assets/js/form-validator.js';
import { ServiceQuote } from './assets/js/service-quote.js';
...
class OzoneWebsite {
    ...
    initWhatsAppIntegration() {
        // Set up WhatsApp buttons with pre-filled messages
        ...
        whatsappButtons.forEach(button => {
            button.addEventListener('click', (e) => {
                ...
                const service = button.getAttribute('data-service') || 'General Inquiry';
                const message = `Hello Ozone Service Solutions!%0A%0AI am interested in your ${service} service. Please provide more details.`;
...
document.addEventListener('DOMContentLoaded', () => {
    const website = new OzoneWebsite();
    
    // Initialize 3D models if the ThreeDModels class is available
    if (typeof ThreeDModels !== 'undefined') {
        const threeDModels = new ThreeDModels();
        threeDModels.initAllScenes();
    }
});
